...
if not st.session_state.logged_in:
    ...
    st.stop()   # <-- Importante: para o código aqui se não estiver logado


# ============================================================
# A PARTIR DAQUI SÓ EXECUTA SE ESTIVER LOGADO
# ============================================================
...
if st.session_state.modulo_atual is None:
    ...
    with col1:
        if st.button("🐔 **Monitoramento de Produção**", use_container_width=True, type="primary"):
            st.session_state.modulo_atual = "monitoramento"
            st.rerun()

    with col2:
        if st.button("💰 **Faturamento & Controle**", use_container_width=True, type="primary"):
            st.session_state.modulo_atual = "faturamento"
            st.rerun()

else:
    # Botão de trocar de módulo (sempre visível)
    if st.sidebar.button("🔄 Trocar de Módulo", use_container_width=True):
        st.session_state.modulo_atual = None
        st.rerun()
...
# ============================================================
# FIM DO BLOCO DO MÓDULO MONITORAMENTO
# ============================================================
...
# ============================================================
else:   # Esse else fecha o if "if st.session_state.modulo_atual == 'monitoramento':"
